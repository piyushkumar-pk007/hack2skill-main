...
`CLIENT_ORIGIN` can be a comma-separated list when you want to allow both local development and your deployed frontend. Use the exact browser origin, without any path like `/api`.
